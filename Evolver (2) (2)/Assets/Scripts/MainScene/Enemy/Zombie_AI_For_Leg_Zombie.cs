...
public class Zombie_AI_For_Leg_Zombie : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (circle.collider)
        {
            ...
            if (GetAngle() > 0f && GetAngle() <= 1.5f)
            {
                ...
                {
                    anim.Play("Leg_Zombie_Right_Walking");
                }
                else
                {
                    anim.Play("Leg_Zombie_Up_Walking");
                }
            }
            else if (GetAngle() >= 1.5f && GetAngle() < 3.0f)
            {
                ...
                {
                    anim.Play("Leg_Zombie_Left_Walking");
                }
                else
                {
                    anim.Play("Leg_Zombie_Up_Walking");
            ...
            else if (GetAngle() > -3.0f && GetAngle() <= -1.5f)
            {
                ...
                {
                    anim.Play("Leg_Zombie_Down_Walking");
                }
            }
